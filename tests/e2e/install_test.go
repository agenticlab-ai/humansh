...
const (
	...
	reportedEnvCommand      = "/usr/bin/env GOPATH=/Users/example/go PYXIS_AGENT_BACKEND=cursor /Users/example/go/bin/dlv dap --log=true --log-output=debugger --client-addr=:59908"
